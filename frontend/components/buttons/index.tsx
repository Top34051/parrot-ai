...
function Button({
    ...
    if (buttonType === 'start-record') {
        return (
            <button onClick={onClick}>
                {size === 'normal' && <BsRecordFill size={10} color='#de5246' tw='
                text-white rounded-full bg-gray-300 h-16 w-16 p-2
                hover:bg-gray-400 active:bg-gray-500
                focus:outline-none focus:ring focus:ring-gray-200
                '/>}
                {size === 'mini' && <BsRecordFill size={10} color='#de5246' tw='
    ...
    if (buttonType === 'stop-record') {
        return (
            <button onClick={onClick}>
                {size === 'normal' && <BsStopFill size={10} color='#de5246' tw='
                text-white rounded-full bg-gray-300 h-16 w-16 p-2
                hover:bg-gray-400 active:bg-gray-500
                focus:outline-none focus:ring focus:ring-gray-200
                '/>}
                {size === 'mini' && <BsStopFill size={10} color='#de5246' tw='
                text-white rounded-3xl bg-gray-300 h-9 w-14 p-1
                hover:bg-gray-400 active:bg-gray-500
                focus:outline-none focus:ring focus:ring-gray-200
                '/>}
    ...
    if (buttonType === 'next') {
        return (
            <button onClick={onClick}>
                {size === 'normal' && <HiArrowSmRight size={20} tw='
                ...
                '/>}
                {size === 'mini' && <HiArrowSmRight size={20} tw='
